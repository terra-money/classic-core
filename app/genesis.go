...
func TerraAppInit() server.AppInit {

	return server.AppInit{
		AppGenState: TerraAppGenStateJSON,
	}
}
...
func TerraValidateGenesisState(genesisState GenesisState) (err error) {
