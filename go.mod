...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/terra-money/cosmos-sdk v0.44.5-public.2
	github.com/CosmWasm/wasmvm => github.com/terra-money/wasmvm v0.16.4-0.20220220060348-bae0189eebdb
