...
replace github.com/cosmos/cosmos-sdk => github.com/terra-money/cosmos-sdk v0.44.0

replace github.com/tendermint/tendermint => github.com/terra-money/tendermint v0.34.12
