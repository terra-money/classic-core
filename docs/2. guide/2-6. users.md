...
::: tip
**Before you can bond atoms and withdraw rewards, you need to [set up `terracli`](#setting-up-terracli)**
:::
...
::: tip
**Before you can bond atoms and withdraw rewards, you need to [set up `terracli`](#setting-up-terracli) and [create an account](#creating-an-account)**
:::
...
terracli tx staking delegate <validatorAddress> <amountToBond> --from <delegatorKeyName> --gas auto --gas-prices <gasPrice>


// Withdraw all rewards
// ex value for flag: <gasPrice>=0.001stake 

terracli tx distr withdraw-all-rewards --from <delegatorKeyName> --gas auto --gas-prices <gasPrice>
...
terracli tx staking unbond <validatorAddress> <amountToUnbond> --from <delegatorKeyName> --gas auto --gas-prices <gasPrice>
```
