...
BUILD_FLAGS = -ldflags "-X github.com/cosmos/cosmos-sdk/version.Version=${VERSION}"
...
build:
	go build $(BUILD_FLAGS) -o bin/terracli cmd/terracli/main.go && go build $(BUILD_FLAGS) -o bin/terrad cmd/terrad/main.go
