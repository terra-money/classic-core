...
func TestCodec(t *testing.T) {
	...
	types.RegisterEvidenceTypeCodec(testEvidence{}, "evidence/testEvidence")
	...
	require.Panics(t, func() { types.RegisterEvidenceTypeCodec(testEvidence{}, "evidence/testEvidence") })
}
