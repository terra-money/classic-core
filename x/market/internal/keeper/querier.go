...
func NewQuerier(keeper Keeper) sdk.Querier {
	return func(ctx sdk.Context, path []string, req abci.RequestQuery) (res []byte, err sdk.Error) {
		...
		case types.QueryLastDayIssuance:
			return queryLastDayIssuance(ctx, req, keeper)
...
func queryLastDayIssuance(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, sdk.Error) {

	bz, err := codec.MarshalJSONIndent(keeper.cdc, keeper.GetLastDayIssuance(ctx))
	if err != nil {
