...
// source: terra/msgauth/v1beta1/tx.proto
...
type MsgGrantAuthorization struct {
	Granter       string        `protobuf:"bytes,1,opt,name=granter,proto3" json:"granter,omitempty" yaml:"granter"`
	Grantee       string        `protobuf:"bytes,2,opt,name=grantee,proto3" json:"grantee,omitempty" yaml:"grantee"`
	Authorization *types.Any    `protobuf:"bytes,3,opt,name=authorization,proto3" json:"authorization,omitempty" yaml:"authorization"`
	Period        time.Duration `protobuf:"bytes,4,opt,name=period,proto3,stdduration" json:"period" yaml:"period"`
}
...
func (*MsgGrantAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{0}
}
...
func (*MsgGrantAuthorizationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{1}
}
...
func (*MsgRevokeAuthorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{2}
}
...
func (*MsgRevokeAuthorizationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{3}
}
...
type MsgExecAuthorized struct {
	Grantee string       `protobuf:"bytes,1,opt,name=grantee,proto3" json:"grantee,omitempty" yaml:"grantee"`
...
func (*MsgExecAuthorized) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{4}
}
...
func (*MsgExecAuthorizedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4983f5c2c3085c2, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgGrantAuthorization)(nil), "terra.msgauth.v1beta1.MsgGrantAuthorization")
	proto.RegisterType((*MsgGrantAuthorizationResponse)(nil), "terra.msgauth.v1beta1.MsgGrantAuthorizationResponse")
	proto.RegisterType((*MsgRevokeAuthorization)(nil), "terra.msgauth.v1beta1.MsgRevokeAuthorization")
	proto.RegisterType((*MsgRevokeAuthorizationResponse)(nil), "terra.msgauth.v1beta1.MsgRevokeAuthorizationResponse")
	proto.RegisterType((*MsgExecAuthorized)(nil), "terra.msgauth.v1beta1.MsgExecAuthorized")
	proto.RegisterType((*MsgExecAuthorizedResponse)(nil), "terra.msgauth.v1beta1.MsgExecAuthorizedResponse")
}

func init() { proto.RegisterFile("terra/msgauth/v1beta1/tx.proto", fileDescriptor_f4983f5c2c3085c2) }

var fileDescriptor_f4983f5c2c3085c2 = []byte{
	// 555 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) GrantAuthorization(ctx context.Context, in *MsgGrantAuthorization, opts ...grpc.CallOption) (*MsgGrantAuthorizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terra.msgauth.v1beta1.Msg/GrantAuthorization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevokeAuthorization(ctx context.Context, in *MsgRevokeAuthorization, opts ...grpc.CallOption) (*MsgRevokeAuthorizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terra.msgauth.v1beta1.Msg/RevokeAuthorization", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ExecAuthorized(ctx context.Context, in *MsgExecAuthorized, opts ...grpc.CallOption) (*MsgExecAuthorizedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terra.msgauth.v1beta1.Msg/ExecAuthorized", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_GrantAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terra.msgauth.v1beta1.Msg/GrantAuthorization",
	}
...
func _Msg_RevokeAuthorization_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terra.msgauth.v1beta1.Msg/RevokeAuthorization",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ExecAuthorized_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terra.msgauth.v1beta1.Msg/ExecAuthorized",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "terra.msgauth.v1beta1.Msg",
	...
	Metadata: "terra/msgauth/v1beta1/tx.proto",
}
...
func (m *MsgGrantAuthorization) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Period, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.Period):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
