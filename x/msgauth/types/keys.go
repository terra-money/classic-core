...
// GetGrantsKey - return grants store key
func GetGrantsKey(granterAddr sdk.AccAddress, granteeAddr sdk.AccAddress) []byte {
	return append(append(GrantKey, granterAddr.Bytes()...), granteeAddr.Bytes()...)
}

// GetAllGrantsKey - return all grants store key
func GetAllGrantsKey(granterAddr sdk.AccAddress) []byte {
	return append(GrantKey, granterAddr.Bytes()...)
}

// GetGranterGranteePrefixKey - return grant store prefix key
func GetGranterGranteePrefixKey(granterAddr sdk.AccAddress, granteeAddr sdk.AccAddress) []byte {
	return append(append(GrantKey, granterAddr.Bytes()...), granteeAddr.Bytes()...)
}

// GetGranterPrefixKey - return grant store prefix key
func GetGranterPrefixKey(granterAddr sdk.AccAddress) []byte {
	return append(GrantKey, granterAddr.Bytes()...)
}
