...
var (
	...
	ErrRecursiveCrossRate    = sdkerrors.Register(ModuleName, 14, "can't get Cross Exchange rate with the same denomination")
	ErrLunaForCrossRate      = sdkerrors.Register(ModuleName, 15, "can't get Cross Exchange rate with the Luna denomination")
	ErrUnknownDenomPair      = sdkerrors.Register(ModuleName, 16, "the denom pair is not known")
)
