...
func queryCrossExchangeRates(ctx sdk.Context, keeper Keeper) ([]byte, error) {
...
func queryCrossExchangeRatesWithDenom(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
	var rates types.CrossExchangeRates
...
func queryCrossExchangeRate(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, error) {
