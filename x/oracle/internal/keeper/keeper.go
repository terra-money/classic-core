...
func (k Keeper) GetCrossExchangeRate(ctx sdk.Context, denom1, denom2 string) (cer types.CrossExchangeRate, err error) {
	if denom1 == denom2 {
		return types.CrossExchangeRate{}, sdkerrors.Wrap(types.ErrRecursiveCrossRate, denom1)
	}

	if denom1 == core.MicroLunaDenom || denom2 == core.MicroLunaDenom{
		return types.CrossExchangeRate{}, types.ErrLunaForCrossRate
	}
	denom1, denom2 = types.GetDenomOrderAsc(denom1, denom2)
	store := ctx.KVStore(k.storeKey)
	b := store.Get(types.GetCrossExchangeRateKey(denom1, denom2))
	if b == nil {
		return types.CrossExchangeRate{}, sdkerrors.Wrap(types.ErrUnknownDenomPair, denom1+"_"+denom2)
	}
	k.cdc.MustUnmarshalBinaryLengthPrefixed(b, &cer)
	return
}

func (k Keeper) GetCrossExchangeRateExported(ctx sdk.Context, denom1, denom2 string) (crossExchangeRate sdk.Dec, err error) {
	if denom1 == denom2 {
		return sdk.ZeroDec(), sdkerrors.Wrap(types.ErrRecursiveCrossRate, denom1)
	}

	if denom1 == core.MicroLunaDenom || denom2 == core.MicroLunaDenom{
		return sdk.ZeroDec(), types.ErrLunaForCrossRate
	}
	denom1, denom2 = types.GetDenomOrderAsc(denom1, denom2)
	store := ctx.KVStore(k.storeKey)
	...
	b := store.Get(types.GetCrossExchangeRateKey(denom1, denom2))
	if b == nil {
		return sdk.ZeroDec(), sdkerrors.Wrap(types.ErrUnknownDenomPair, cer.DenomPair())
	}
	k.cdc.MustUnmarshalBinaryLengthPrefixed(b, &cer)
