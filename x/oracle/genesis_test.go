...
func TestExportInitGenesis(t *testing.T) {
	...
	input.OracleKeeper.AddPrevote(input.Ctx, NewExchangeRatePrevote("1234", "denom", sdk.ValAddress{}, int64(2)))
	input.OracleKeeper.AddVote(input.Ctx, NewExchangeRateVote(sdk.NewDec(1), "denom", sdk.ValAddress{}))
