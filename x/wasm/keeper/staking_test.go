...
// 	// STEP 2: Prepare the reflect contract
...
// 	require.NoError(t, err)
// 	reflectID, err := initInfo.contractKeeper.Create(ctx, creator, reflectCode, "", "", nil)
// 	require.NoError(t, err)
// 	require.Equal(t, uint64(2), reflectID)

// 	// creator instantiates a contract and gives it tokens
// 	reflectAddr, _, err := initInfo.contractKeeper.Instantiate(ctx, reflectID, creator, nil, []byte("{}"), "reflect contract 2", nil)
// 	require.NoError(t, err)
...
// 	res, err := keeper.QuerySmart(ctx, reflectAddr, reflectBondedBin)
// 	require.NoError(t, err)
...
// 	res, err = keeper.QuerySmart(ctx, reflectAddr, reflectValidatorsBin)
// 	require.NoError(t, err)
// 	// first we pull out the data from chain response, before parsing the original response
// 	mustParse(t, res, &reflectRes)
...
// 	res, err = keeper.QuerySmart(ctx, reflectAddr, reflectAllDelegationsBin)
// 	require.NoError(t, err)
// 	// first we pull out the data from chain response, before parsing the original response
// 	mustParse(t, res, &reflectRes)
...
// 	res, err = keeper.QuerySmart(ctx, reflectAddr, reflectDelegationBin)
// 	require.NoError(t, err)
// 	// first we pull out the data from chain response, before parsing the original response
// 	mustParse(t, res, &reflectRes)
