...
func TestValidateGenesisInvalidAccounts(t *testing.T) {
	...
	baseVestingAcc, err := authvesttypes.NewBaseVestingAccount(&acc1, acc1.Coins, 1548775410)
	...
	genAccs[0] = NewLazyGradedVestingAccountRaw(baseVestingAcc, VestingSchedules{VestingSchedule{sdk.DefaultBondDenom, LazySchedules{LazySchedule{1654668078, 1554668078, sdk.OneDec()}}}})
	require.Error(t, authtypes.ValidateGenAccounts(genAccs))
}
