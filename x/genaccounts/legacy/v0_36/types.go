...
type (
	GenesisAccount struct {
		...
		VestingSchedules []auth.VestingSchedule `json:"vesting_schedules" yaml:"vesting_schedules"`
...
func NewGenesisAccount(
	...
	vestinSchedules []auth.VestingSchedule, module string, permissions []string,
) GenesisAccount {
	...
	return GenesisAccount{
		...
		VestingSchedules:  vestinSchedules,
		ModuleName:        module,
